...
export default function Lanyard({
    ...
    return (
        <div className="relative z-0 w-full h-screen flex justify-center items-center transform scale-100 origin-center" style={{ width: '100%', height: '100%' }}>
            <Canvas
                camera={{ position, fov }}
...
if (rootElement) {
    ...
    root.render(<Lanyard transparent={true} />);
}
